          ...
          <View style={styles.statsTab}>
            ...
            <View style={styles.statsGrid}>
              {statKeys.map(stat => {
                ...
                const desc = classConfig.statDescriptions[stat];
                return (
            ...
            <View style={styles.heroBoostBox}>
              ...
              <Text style={styles.heroBoostValue}>+{(stats.teamBoostPercent * 100).toFixed(2)}% to Team DPS</Text>
            </View>
            ...
            <View style={styles.metaBox}>
              ...
              <Text style={styles.sectionHelperText}>
                ⓘ Meta paths modify final run multipliers: Damage to DPS, Economy to gold, Survival to HP/defense.
              </Text>
              ...
              <View style={styles.rebirthTreeCard}>
                ...
                <Text style={styles.sectionHelperText}>
                  ⓘ Rebirth branches are permanent multipliers applied on top of run stats after each ascension.
                </Text>
                <View style={styles.metaUpgradeRow}>
                  <View style={styles.metaUpgradeInfo}>
                    <Text style={styles.metaUpgradeName}>Damage Branch Lv {state.rebirthDamagePath}</Text>
                    <Text style={styles.metaUpgradeDesc}>
                      +7% to final DPS multiplier per level (rebirth-only track)
                    </Text>
                  </View>
                  <Pressable
                    style={[
                      styles.metaUpgradeBtn,
                      state.rebirthCores < rebirthDamageCost && styles.metaUpgradeBtnDisabled,
                    ]}
                ...
                <View style={styles.metaUpgradeRow}>
                  <View style={styles.metaUpgradeInfo}>
                    ...
                    <Text style={styles.metaUpgradeDesc}>
                      +7% to final gold multiplier per level (rebirth-only track)
                    </Text>
                  </View>
                  <Pressable
                    style={[
                      styles.metaUpgradeBtn,
                      state.rebirthCores < rebirthEconomyCost && styles.metaUpgradeBtnDisabled,
                    ]}
                ...
                <View style={styles.metaUpgradeRow}>
                  <View style={styles.metaUpgradeInfo}>
                    ...
                    <Text style={styles.metaUpgradeDesc}>
                      +7% to team HP and defense scaling per level (rebirth-only track)
                    </Text>
                  </View>
                  <Pressable
                    style={[
                      styles.metaUpgradeBtn,
                      state.rebirthCores < rebirthSurvivalCost && styles.metaUpgradeBtnDisabled,
                    ]}
            ...
            <View style={styles.masteryCard}>
              ...
              <Text style={styles.masteryLevel}>
                Mastery Level {classMasteryLevel}{' '}
                <Text style={styles.masteryLevelSub}>(1 level per 100 mastery XP)</Text>
              </Text>
              <View style={styles.hpBarBg}>
                <View
                  style={[
                    styles.hpBarFill,
                    {
                      width: `${(state.playerClass ? state.classMasteryXp[state.playerClass] : 0) % 100}%`,
                      backgroundColor: '#7BD9A8',
                    },
                  ]}
                />
              </View>
              <Text style={styles.masteryHint}>
                {(state.playerClass ? state.classMasteryXp[state.playerClass] : 0) % 100}/100 mastery XP to next level
              </Text>
              {[
                ...
                <View key={m.lvl} style={styles.masteryMilestoneRow}>
                  <Text style={[styles.masteryMilestoneCheck, m.done && styles.masteryMilestoneDone]}>
                    {m.done ? '✅' : '○'}
                  </Text>
                  <View>
